...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT(
        ...
        KC_LCTRL, KC_Z, KC_X, KC_C,    KC_V,    KC_B,            KC_NO,               KC_NO,           KC_K,            KC_M,    KC_COMM,         KC_DOT,             KC_SLSH, KC_RSFT,
                     KC_LGUI, KC_LALT, KC_LSFT, LT(_NAV, KC_SPC), LT(_MOUSE, KC_TAB),   LT(_NUM, KC_EQL), LT(_SYM, KC_ENT), KC_BSPC, LT(_FUN, KC_DEL), LT(_MEDIA, KC_APP)),
    [_GAMING]  = LAYOUT(
        // KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,   KC_5,                      KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, /
        ...
        KC_LCTRL, KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,  KC_NO,       KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
